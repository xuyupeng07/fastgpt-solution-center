...
const FeatureList: FeatureItem[] = [
  {
    ...
    lightImg: 'img/features/feature-rag-light.jpg',
    darkImg: 'img/features/feature-rag-dark.jpg',
  },
  {
    ...
    lightImg: 'img/features/feature-workflow-light.jpg',
    darkImg: 'img/features/feature-workflow-dark.jpg',
  },
  {
    ...
    lightImg: 'img/features/feature-agent-light.jpg',
    darkImg: 'img/features/feature-agent-dark.jpg',
  },
];
  ...
  return (
    <section className={styles.section}>
      <img
        ...
        src={useBaseUrl('img/shapes/blurred-shape-light.svg')}
        alt=""
        aria-hidden="true"
      />
      <img
        className={clsx(styles.bgShape, styles.bgShapeBottom, styles.bgDark)}
        src={useBaseUrl('img/shapes/blurred-shape.svg')}
        alt=""
        aria-hidden="true"
      />
